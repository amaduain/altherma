...
#define WIFI_SSID "WLAN_3COM"//**Your SSID here**
#define WIFI_PWD "TuGrGl9Q79AErsiT3xDKkDXESK94ZfQP8wamEYph1zLk9gWWafs158CDZO1NyvN"//**Your password here** leave empty if open (bad!)

#define MQTT_SERVER "192.168.2.101"//**IP address here of your MQTT server**
